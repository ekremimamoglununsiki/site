...
$server = new SocketServer("https://site-production-09c0.up.railway.app",31337); // Create a Server binding to the given ip address and listen to port 31337 for connections
